        ...
        return (
                <div>
                    ...
                    <p>
                        ...
                        Refuser : au lieu d’encombrer votre maison de choses que vous savez inutiles (donc qui finiront à la poubelle ou au fond du placard) quand on vous les propose, dites simplement non.
                        Réduire : attaquez la mission de désencombrement de votre maison, un de mes thèmes favoris. Mais au lieu de jeter, donnez, vendez, recyclez, tout est bon pour éviter de jeter.
                        Réutiliser : ne laissez pas dormir les vieux objets. Trouvez-leur une seconde vie.
                        Recycler : le bon sens vous invite à aller déposer dans des centres de collecte vos objets qui ne serviront plus jamais à vous ou quelqu’un d’autre. Aidez les collectivités à recycler proprement en allant à votre déchetterie locale.
                        Composter : pour tous vos déchets organiques, un bac à compost au fond du jardin ou un lombricomposteur pour ceux qui vivent en appartement et qui ont un balcon. Fabriquez un super engrais pour votre jardin.

                        Si vous me suivez depuis quelque temps, vous savez que vous aider à désencombrer votre maison est important pour moi. Donc si vous avez commencé à suivre mes conseils, vous avez déjà entamé une démarche allant vers le zéro déchet. Pour vous aider à y arriver, voici une liste non-exhaustive de ce que vous pouvez mettre en place dès aujourd’hui !
                        ...
                        Je vous en parlais dans un article précédent, regrouper la préparation de tous vos plats de la semaine en quelques heures vous fera certes, gagner du temps, mais surtout vous lutterez contre le gaspillage. En cuisinant les bonnes portions en avance, vous limitez les achats inutiles et trop de restes. Dans l’article Adopter le minimalisme et le zéro déchet en cuisine, vous trouverez plein de petites astuces adaptées à la cuisine.
                        4 – Utilisez du savon en brique

                        Terminés les gels douche et leurs contenants en plastique qui seront toujours en l’état dans 1000 ans. Le savon en brique posé sur un porte savonnette vous offrira le même confort que le gel douche, sans les déchets en plastique. Vous trouverez des savons adaptés à votre type de peau partout dans le commerce.
                        ...
                        Pour votre bébé, vous lui mettez des couches jetables ? Non seulement, c’est un des produits les plus polluants au monde puisqu’elles ne se désintègrent pas malgré ce que l’on veut vous faire croire, mais en plus, elles coûtent cher. Comme nous en parlons dans l’article sur la liste de naissance minimaliste, vous trouverez d’autres astuces de maman pour réduire les déchets liés à bébé.
                        8 – Achetez en vrac
                        ...
                        De plus en plus de magasins zéro déchet font leur apparition un peu partout. Ouvrez-l’oeil et renseignez-vous. Je suis certaine qu’il y a un ou même plusieurs magasins ZD ou vrac près de chez vous.
                        9 – Lisez autrement
